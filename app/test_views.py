...
from app import app
from app.processing import find_stores, find_home, get_data, make_test_site
...
@app.route("/test/locate", methods=['GET', 'POST'])
def test_locate():
    today = date.today()
    ...
    if stores != None:
        ...
        return render_template("/test/error.html", cAL=cAL, cJM=cJM, cJN=cJN, cr5=cr5, cr10=cr10, cr25=cr25, cr50=cr50)